...
public class JavaMLP
{
 ...
 public static int numPatterns = 365; //number of training patterns
 public static double LR_IH = 0.1; //learning rate
 public static double LR_HO = 0.01; //learning rate
 public static double[][]trainin=new double[365][5];
 public static double[]trainop=new double[365];
...
//in.normalize();
//in.normalizeInputs(InputTrainingSets.traininput);
//JavaMLP.trainInputs=InputTrainingSets.input_feature;
//JavaMLP.trainOutput=InputTrainingSets.expected_output;
...
trainop=Normalize.trainoutput;
trainin=Normalize.traininput;
for(int j = 0;j<5;j++)
  {
    trainOutput[j] = trainop[j];
    for(int i = 0;i<365;i++)
    trainInputs[i][j]=trainin[i][j] ;
  }
